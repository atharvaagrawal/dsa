...
We can make one bouquet of the first three flowers that bloomed. We cannot make another bouquet from the 
last three flowers that bloomed because they are not adjacent.
    ...
    def minDays(self, bloomDay: List[int], m: int, k: int) -> int:
        ...
        def isEnoughDays(days):
            ...
            for d in bloomDay:
                ...
                # 0 because we required ajacent flowers
